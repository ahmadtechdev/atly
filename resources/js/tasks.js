    ...
    return `
        <div class="space-y-5">
            ...
            <dl class="grid grid-cols-2 gap-3 text-sm">
                <div class="rounded-lg bg-atly-muted/30 p-3"><dt class="text-atly-ink-soft">Start</dt><dd class="mt-1 font-medium text-atly-ink">${task.start_date ?? '—'}</dd></div>
                <div class="rounded-lg bg-atly-muted/30 p-3"><dt class="text-atly-ink-soft">Due</dt><dd class="mt-1 font-medium ${task.is_overdue ? 'text-rose-600' : 'text-atly-ink'}">${task.due_date ?? '—'}</dd></div>
            </dl>
            ...
            <div class="flex flex-wrap gap-2 border-t border-atly-border pt-4">
