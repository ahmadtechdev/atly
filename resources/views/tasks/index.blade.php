<x-layouts.dashboard title="Tasks">
    <div class="grid gap-6 xl:grid-cols-[1fr_minmax(0,22rem)]">
        ...
        <aside id="task-detail-panel" class="hidden xl:block">
            <div class="sticky top-24 rounded-atly-lg border border-atly-border bg-atly-card p-6 shadow-atly">
                <div id="task-detail-empty" class="py-12 text-center">
                ...
                <div id="task-detail-content" class="hidden"></div>
            </div>
        </aside>
    </div>
    ...
    <div id="task-detail-drawer" class="fixed inset-0 z-50 hidden xl:hidden" aria-hidden="true">
        ...
        <div class="absolute bottom-0 left-0 right-0 max-h-[85vh] overflow-y-auto rounded-t-2xl border border-atly-border bg-atly-card p-6 shadow-atly-lg">
            <div id="task-detail-drawer-content"></div>
        </div>
    </div>
