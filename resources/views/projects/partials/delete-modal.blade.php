...
<div id="project-delete-modal" class="fixed inset-0 z-50 hidden overflow-y-auto overscroll-contain" aria-hidden="true">
    <div data-close-project-delete class="fixed inset-0 bg-atly-ink/50 backdrop-blur-sm"></div>
    <div class="pointer-events-none relative flex min-h-full items-start justify-center p-4 sm:items-center sm:p-6">
        <div class="pointer-events-auto w-full max-w-md rounded-atly-lg border border-atly-border bg-atly-card p-5 shadow-atly-lg sm:p-6" role="dialog" aria-modal="true" aria-labelledby="project-delete-title">
