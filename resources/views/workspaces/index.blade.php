<x-layouts.dashboard title="Workspaces">
    <div class="space-y-4">
        <div class="flex flex-wrap items-center justify-between gap-3">
            <p class="text-sm text-atly-ink-soft">{{ $workspaces->total() }} {{ $workspaces->total() === 1 ? 'workspace' : 'workspaces' }}</p>
            <button
                type="button"
                data-open-workspace-modal
        ...
        <div id="workspaces-list-wrapper" class="space-y-3">
            @include('workspaces.partials.list', ['workspaces' => $workspaces])
        </div>
    </div>
</x-layouts.dashboard>
