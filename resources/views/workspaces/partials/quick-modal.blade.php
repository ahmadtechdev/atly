@auth
    ...
    <div id="workspace-quick-modal" class="fixed inset-0 z-50 hidden overflow-y-auto overscroll-contain" aria-hidden="true">
        <div data-close-workspace-modal class="fixed inset-0 bg-atly-ink/50 backdrop-blur-sm"></div>
        <div class="pointer-events-none relative flex min-h-full items-start justify-center p-4 sm:items-center sm:p-6">
            <div class="pointer-events-auto w-full max-w-lg rounded-atly-lg border border-atly-border bg-atly-card p-5 shadow-atly-lg sm:p-7" role="dialog" aria-modal="true" aria-labelledby="workspace-modal-title">
